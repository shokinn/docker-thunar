...
[![](https://images.microbadger.com/badges/image/shokinn/docker-thunar.svg)](https://microbadger.com/images/shokinn/docker-thunar "Docker image size")

You can invite me a beer if you want ;) 

This is a completely funcional Docker image with Thunar.
...
```bash
docker run -d --name=thunar \
-v /share/Container/thunar/config:/config \
-v /share/Container/thunar/media:/media \
-e GROUP_ID=0 \
-e USER_ID=0 \
-e TZ=Europe/Madrid \
-p 5800:5800 \
-p 5900:5900 \
shokinn/thunar:latest
```

Browse to `http://your-host-ip:5800` to access the Thunar GUI.
